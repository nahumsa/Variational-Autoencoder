...
class VariationalAutoencoder_Keras():
    """
    ...
    encoder_conv_filters(list): List of filters of the convolutional 
                                layer of the encoder.
    encoder_conv_kernel_size(list): List of Kernel Size of the convolutional 
                                layer of the encoder.
    encoder_conv_strides(list): List of strides of the convolutional 
                                layer of the encoder.
    decoder_conv_t_filters(list): List of filters of the convolutional
                                transpose layer of the decoder.
    decoder_conv_t_kernel_size(list): List of Kernel Size of the convolutional 
                                transpose layer of the decoder.
    decoder_conv_t_strides(list): List of strides of the convolutional 
                                transpose layer of the decoder.
    ...
    def __init__(self
        ...
        self.name = 'variational_autoencoder_conv'
...
class Scinet_VariationalAutoencoder_Keras():
    """
    Variational Autoencoder with Dense layers.
